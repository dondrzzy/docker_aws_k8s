...
app.post('/signup', async (req, res) => {
  ...
  try {
    const response = await axios.get(`http://${process.env.AUTH_ADDRESS}/hashed-password/` + password);
    // const response = {data: "dummy text"}
...
app.listen(8080, () => console.log('User server started on port 8080'));
